module.exports = (sequelize, DataTypes) => {
  ...
  const Asiento = sequelize.define('t_asientos', {
      ...
      id_avion: { type: DataTypes.INTEGER, references: { model: 't_aviones', key: 'id_avion' } },
      id_vuelo: { type: DataTypes.INTEGER, references: { model: 't_vuelos', key: 'id_vuelo' } },
      fila: { type: DataTypes.INTEGER, allowNull: false },
      columna: { type: DataTypes.CHAR, allowNull: false },
      codigo_asiento: { type: DataTypes.STRING, allowNull: false },
      clase: { type: DataTypes.STRING, defaultValue: 'economica' },
